...
public static void reload(int amount) throws InterruptedException {
    ...
    public static  void setPenCount(int penCount){
    ...
    //two or more threads may receive wrong info of quantity
    //but doesnt actually break beacuse only one salesperson can sell at a time.
    ...
    //get correct number of crayons, but may set incorrect amount after transaction (sell more then you have)
    public static void setCrayonCount(int crayonCount) {
